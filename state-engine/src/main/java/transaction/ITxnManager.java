...
public interface ITxnManager {
    ...
    boolean Asy_ModifyRecord_Read(TxnContext txn_context, String srcTable, String key, SchemaRecordRef record_ref, Function function, int[] success) throws DatabaseException;
