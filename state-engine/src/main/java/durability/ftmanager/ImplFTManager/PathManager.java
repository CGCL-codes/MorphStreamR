...
public class PathManager extends FTManager {
    ...
    //Call if log persist complete
    private ConcurrentHashMap<Long, List<FaultToleranceConstants.FaultToleranceStatus>> callPersist = new ConcurrentHashMap<>();
    //Call if all tuples in this group committed
    private ConcurrentHashMap<Long, List<FaultToleranceConstants.FaultToleranceStatus>> callCommit = new ConcurrentHashMap<>();
    private ConcurrentHashMap<Long, durability.logging.LoggingResult.LoggingCommitInformation> registerCommit = new ConcurrentHashMap<>();
