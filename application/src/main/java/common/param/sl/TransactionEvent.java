...
public class TransactionEvent extends TxnEvent {
     ...
     */
    public TransactionEvent(long bid, int partition_id, String bid_array, String partition_index,
    ...
    public TransactionEvent cloneEvent() {
        TransactionEvent transactionEvent = new TransactionEvent(bid, pid, Arrays.toString(bid_array), Arrays.toString(partition_indexs), number_of_partitions, sourceAccountId, sourceBookEntryId, targetAccountId, targetBookEntryId, accountTransfer, bookEntryTransfer);
