...
import common.faulttolerance.inputReload.TPInputDurabilityHelper;
...
public class FTTPCombo extends FTSPOUTCombo {
    private static final Logger LOG = LoggerFactory.getLogger(FTTPCombo.class);
    ...
    public void initialize(int thread_Id, int thisTaskId, ExecutionGraph graph) {
        ...
        this.inputDurabilityHelper = new TPInputDurabilityHelper(config, thisTaskId, this.compressionType);
